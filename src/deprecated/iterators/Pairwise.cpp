...
nd::deprecated::iterator::Pairwise::Pairwise(coords attr0, coords attr1) {
...
shape_t& nd::deprecated::iterator::Pairwise::indices_at(big_size_t index_1d,
	...
	if (pair_index > 2) {
		throw nd::exception("Invalid pair_index, "
				"nd::deprecated::iterator::Pairwise::indices_at(..., uflag8_t pair_index)");
	}
...
big_size_t nd::deprecated::iterator::Pairwise::index_at(big_size_t index_1d,
		min_size_t pair_index) {
...
coords nd::deprecated::iterator::Pairwise::aligned_coords(min_size_t pair_index) {

	return this->attr_list[pair_index];
}

shape_t& nd::deprecated::iterator::Pairwise::clipped_indices() {
	return this->clipped_cache;
}

nd::deprecated::iterator::RandomAccess& nd::deprecated::iterator::Pairwise::iter_of(
		min_size_t pair_index) {
...
nd::deprecated::iterator::Pairwise::~Pairwise() {
